...
class SaleOrderLine(models.Model):
    ...
    def _compute_qty_returned(self):
        """Compute pack returned quantities according to its components returns"""
        ...
        for line in main_pack_lines.filtered(
            ...
            for pack_line in line.pack_child_line_ids.filtered("product_uom_qty"):
                qty_per_pack = pack_line.product_uom_qty / line.product_uom_qty
                returned_packs.append(pack_line.qty_returned / qty_per_pack)
            line.qty_returned = returned_packs and min(returned_packs) or 0.0
        return res
